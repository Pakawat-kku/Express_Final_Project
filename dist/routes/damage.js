...
const damage_1 = require("../models/damage");
const express_1 = require("express");
const jwt_1 = require("../models/jwt");
const HttpStatus = require("http-status-codes");
const jwt = new jwt_1.Jwt();
const router = express_1.Router();
const damageModel = new damage_1.DamageModel();
router.get('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
    let db = req.db;
    try {
        const result = yield damageModel.get(db);
...
router.post('/', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const result = yield damageModel.insert(db, data);
        res.send({ ok: true, statusCode: HttpStatus.OK, rows: result });
    }
    catch (error) {
        console.log(error.message);
...
router.post('/sumByClothId', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const result = yield damageModel.sumByClothId(db, clothId);
        res.send({ ok: true, statusCode: HttpStatus.OK, rows: result });
    }
    catch (error) {
        console.log(error.message);
...
router.post('/getByClothId', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    let clothId = req.body.clothId;
    try {
        const result = yield damageModel.getByClothId(db, clothId);
        res.send({ ok: true, statusCode: HttpStatus.OK, rows: result });
    }
    catch (error) {
        console.log(error.message);
...
router.post('/searchByDate', (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const result = yield damageModel.searchByDate(db, dateSearch1, dateSearch2);
        res.send({ ok: true, statusCode: HttpStatus.OK, rows: result });
    }
    catch (err) {
